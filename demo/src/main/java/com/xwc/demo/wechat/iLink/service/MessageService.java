...
import com.xwc.demo.wechat.iLink.core.model.ApiResponse;
...
import com.xwc.demo.wechat.iLink.core.model.SendMessageRequest;
    ...
    public void sendText(LoginContext loginContext, String toUserId, String text) throws IOException {
        ...
        SendMessageRequest.Msg msg =
            new SendMessageRequest.Msg(
                ...
                ctx.getLatestContextToken(),//// ⭐ 取出缓存的 token
